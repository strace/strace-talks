...
\scriptsize
\begin{block}{\large Podporované v současnosti protokoly netlink}
\begin{itemize}
\item NETLINK\_AUDIT
...
\begin{description}
	\item[comm]: výpis jména příkazu (právě \texttt{comm}) spojeného s ID vlákna nebo procesu
	\item[pidns]: výpis ID vlákna, procesu, procesové skupiny, nebo seance v jmenném prostoru strace,
